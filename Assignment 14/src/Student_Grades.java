...
class Student {
    ...
    public double calculateAverage() {
        ...
        return (double) total / grades.length;  // Correct calculation and return the average
    }
    ...
    public void displayDetails() {
        ...
        System.out.println("Average Grade: " + calculateAverage());  // Call the calculateAverage() method
